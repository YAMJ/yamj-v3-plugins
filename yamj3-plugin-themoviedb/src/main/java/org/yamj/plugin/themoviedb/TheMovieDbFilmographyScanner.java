...
@Extension
public final class TheMovieDbFilmographyScanner extends AbstractTheMovieDbScanner implements FilmographyScanner {

    private static final Logger LOG = LoggerFactory.getLogger(TheMovieDbFilmographyScanner.class);
